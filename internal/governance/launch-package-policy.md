...
For component prototype libraries such as Base and Shadcn, the complete npm package is the installation, versioning, and release unit, while an anatomy-family subpath is the recommended import unit. For example, Button should be consumed from `@proto.ui/prototypes-base/button` or `@proto.ui/prototypes-shadcn/button`.
