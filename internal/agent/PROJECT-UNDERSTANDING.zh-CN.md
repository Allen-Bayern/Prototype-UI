...
| 工作区快照指纹 | `sha256:96ce53e4d3fff4c178fcda53e3fef6f7c69c7a873583944db093da268bb5dd68` |
...
当前快照包含 40 个 active、400 个 draft、5 个 deprecated、0 个 removed 实体。
...
- 400/445 个实体仍为 draft；catalog 广度不能直接解释为稳定度。
