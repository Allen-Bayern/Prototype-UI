...
| 工作区快照指纹 | `sha256:90a5e9f66cf2918715c171ac948188fe92cdbe655cbd3f10e4e67a7c742e05f0` |
...
当前快照包含 39 个 active、350 个 draft、5 个 deprecated、0 个 removed 实体。
...
- 350/394 个实体仍为 draft；catalog 广度不能直接解释为稳定度。
