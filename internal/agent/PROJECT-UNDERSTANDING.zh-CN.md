...
| 工作区快照指纹 | `sha256:7e3a2115312c2114f5e4637be5c43c68ca7ab3ca0e994902d538a5d9b7ba34e1` |
...
当前快照包含 37 个 active、350 个 draft、5 个 deprecated、0 个 removed 实体。
...
- 350/392 个实体仍为 draft；catalog 广度不能直接解释为稳定度。
