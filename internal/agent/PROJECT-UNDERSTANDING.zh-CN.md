...
| 工作区快照指纹 | `sha256:b037f1bd2225fb10902387fc4ba8358751f3b792e80691c21ce25e733f9eb54a` |
...
当前快照包含 40 个 active、363 个 draft、5 个 deprecated、0 个 removed 实体。
...
| `prototype` | 67 | 0 | 67 | 0 | 67 | 67 | 32 |
| `module` | 5 | 1 | 4 | 0 | 0 | 0 | 0 |
| `host-cap` | 4 | 0 | 4 | 0 | 2 | 2 | 0 |
| `test` | 127 | 12 | 115 | 0 | 0 | 0 | 4 |
...
- 363/408 个实体仍为 draft；catalog 广度不能直接解释为稳定度。
