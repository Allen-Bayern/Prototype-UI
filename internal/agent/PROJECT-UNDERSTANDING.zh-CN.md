...
| 工作区快照指纹 | `sha256:ccc8f444a2642c8447a3596650de3ab2579616e94c76338944137bd7f1419bfd` |
...
当前快照包含 38 个 active、350 个 draft、5 个 deprecated、0 个 removed 实体。
...
- 350/393 个实体仍为 draft；catalog 广度不能直接解释为稳定度。
