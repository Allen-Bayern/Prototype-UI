...
> Published on July 26, 2026 under the npm `next` channel. All 37 public packages, the `v0.2.0-rc.6` tag, the GitHub prerelease, and the immutable spec snapshot share this exact release identity.
...
- Additional installation, runtime, CSS, accessibility, bundle, composition, and API findings from post-publication `0.2.0-rc.6` trials will enter a later release train.
