...
> 已于 2026 年 7 月 26 日通过 npm `next` channel 发布。全部 37 个公开 package、`v0.2.0-rc.6` tag、GitHub prerelease 与不可变 spec snapshot 共享这一精确发行身份。
...
- `0.2.0-rc.6` 发布后试用继续发现的安装、运行时、CSS、a11y、bundle、组合与 API 问题将进入后续 release train。
