...
For a snapshot-centered overview of the project, read `internal/agent/PROJECT-UNDERSTANDING.zh-CN.md`. For entity authoring and governance, read `spec/README.md`.
...
- Agent/documentation-only changes: regenerate the Agent project understanding, run `check:agent-doc`, and validate referenced paths.
...
Generated files must be changed through their generator. `internal/agent/PROJECT-UNDERSTANDING.zh-CN.md` is generated by `scripts/spec/generate-agent-project-understanding.mjs`.
